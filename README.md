...
- Регистрация и вход (Supabase Auth), сброс пароля по ссылке из письма
- Профиль: имя, аватар
- Invite-ссылки → «знакомства» (Connections), список знакомых с аватарами и меткой «знакомы N дней»
