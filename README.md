...
- Mute и блокировка знакомого без разрыва «знакомства» — mute прячет его посты только от тебя, блокировка скрывает посты в обе стороны
